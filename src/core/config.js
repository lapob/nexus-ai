...
const DEFAULTS = Object.freeze({
  ...
  research: Object.freeze({ enabled: true, provider: 'auto', braveApiKey: '', timeoutMs: 6000, cacheTtlMs: 300000 }),
...
function loadRuntimeConfig(env = process.env) {
  ...
  if (!['auto', 'brave', 'wikipedia'].includes(researchProvider)) throw new Error('NEXUS_WEB_SEARCH_PROVIDER deve essere auto, brave o wikipedia.');
